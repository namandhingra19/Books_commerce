...
const Ratings=()=>{
    ...
    const rating=useSelector<RootState,number>(state=>state.products.rating.value)
        ...
        for(let i=0;i<5;i++){
            ...
            array.push(
                <div className={classes} key={i}>
                    ...
                    <input type="checkbox" id="scales" name={`${i}`} 
    ...
    return(
        <Fragment>
        <h4>Rating</h4>
            <div className={style.ratingdiv} onMouseLeave={mouseleaveHandler} onMouseEnter={mouseenterHandler2}>
                {
                    arraylist.map((el)=>{
                        return(
                            el
