...
const Item:React.FC<{image:string, name:string,price:string,description:string,genre:string}>=(props)=>{
    ...
    return(
        <div className={style.main} onMouseEnter={enterHandler} onMouseLeave={leaveHandler}>
